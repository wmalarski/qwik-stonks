...
const textFieldRootVariants = cva({
  base: {
    display: "inline-flex",
    flexShrink: 0,
    cursor: "pointer",
...
export const TextFieldRoot = styled("div", textFieldRootVariants);
...
export const TextFieldInput = styled("input", textFieldInputVariants);
...
export const TextFieldLabel = styled("div", textFieldLabelVariants);

const textFieldErrorMessageVariants = cva({
  base: {
    display: "inline-flex",
    flexShrink: 0,
    cursor: "pointer",
...
export const TextFieldErrorMessage = styled(
  "span",
  textFieldErrorMessageVariants,
);
